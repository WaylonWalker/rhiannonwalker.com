...
<head>
    ...
    <link rel="amphtml" href="https://rhiannonwalker.com/{{ slug }}/amp/" />
    ...
    <link href="/8bitcc.png" rel="apple-touch-icon" sizes="512x512" />
...
<body>
    <nav>
        <ul>
            ...
            <li>
                <a href="/rss.xml" aria-label="RSS">
                    <svg class="icon" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 24 24" height="16" width="16">
        ...
        <div id="title-wrapper">
            <a class="u-url" href="https://rhiannonwalker.com/{{ slug }}/">
                <h1  id="title" style="
              text-align: right;
              z-index: 2;
...
<xsl:value-of select="/rss/channel/title"/>
            ...
            <div class="h-card p-author" rel="author">
                <div class="content">
                    <a class="p-name u-url" href="https://rhiannonwalker.com/">
                        <p>
                            <span class="p-given-name">Rhiannon</span>
